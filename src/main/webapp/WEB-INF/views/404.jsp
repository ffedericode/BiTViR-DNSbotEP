...
<title>Cannot find the server.</title>
</head>
...
<table width="400" cellpadding="3" cellspacing="5">
    ...
    style="COLOR: black; FONT: 13pt/15pt verdana"><span id="errorText"><img src="gfx/pagerror.gif" width="25" height="33" align="left">The page cannot be displayed.</span></h1></td>
        </tr>
        <tr> 
          <td id="tablePropsWidth" width="400" colspan="2"><font
    style="COLOR: black; FONT: 8pt/11pt verdana">The page you are looking for 
            is currently unavailable. The Web site might be experiencing 
            technical difficulties, you may need to adjust your browser settings.</font></td>
        </tr>
        <tr> 
    ...
    style="COLOR: black; FONT: 8pt/11pt verdana"> 
            ...
            <ul>
              <li id="instructionsText1">Click the <a href="/index.php?refresh="> 
                <img src="gfx/refresh.gif" width="13" height="16" border="0">Refresh</a> 
                button, or try again later.<br>
              </li>
              <li id="instructionsText2">If you typed the page address in the 
                Address bar, make sure that it is spelled correctly.<br>
              </li>
              <li id="instructionsText3">To check your connection settings, click the 
                <b>tools</b> menu, and then click <b>Internet Options</b>. On the
                <b>Connections</b> tab, click <b>Settings</b>. The settings 
                should match those provided by your local area network (LAN) 
                administrator or Internet service provider (ISP). </li>
            ...
            <h2 id="IEText" style="font:8pt/11pt verdana; color:black">Cannot 
              find server or DNS Error<BR>
              Internet Exploder </h2>
            </font></td>
        </tr>
      </table></td>
    <td width="48%" valign="top"><div align="right">
</div></td>
  </tr>
</table>
</body>
